...
import { Calendar, Clock, MapPin, Users, BookOpen, QrCode, LogOut } from 'lucide-react';
...
export default function TeacherSchedulePage() {
  ...
  const fetchSchedule = async () => {
    try {
      setLoading(true);
      const data = await apiClient.getSchedule('teacher');
      setSchedules(data);
    } catch (err: any) {
  ...
  const handleGenerateQR = (scheduleId: number) => {
    navigate('/teacher/qr-stream', { state: { scheduleId } });
  };

  return (
    <div className="min-h-screen bg-linear-to-br from-purple-50 to-pink-100 dark:from-zinc-900 dark:to-zinc-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              View your teaching schedule and generate QR codes for attendance
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
